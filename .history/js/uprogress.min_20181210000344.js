(function() {
  ...
  var t = {
      extend: function(t, e) {
        if (((e = JSON.parse(JSON.stringify(e))), 'string' == typeof t))
          return e;
        var s, r;
        for (var s in t)
          (r = t[s]), t.hasOwnProperty(s) && void 0 !== r && (e[s] = r);
        return e;
      },
      queue: (function() {
        function t() {
      ...
      setcss: (function() {
        ...
        function e(t) {
          ...
          if (t in e) return t;
          for (
            var s, r = i.length, n = t.charAt(0).toUpperCase() + t.slice(1);
            r--;

          )
            if (((s = i[r] + n), s in e)) return s;
          return t;
        }
        function s(s) {
        ...
        return function(t, e) {
          ...
          if (2 == n.length)
            for (s in e)
              (i = e[s]), void 0 !== i && e.hasOwnProperty(s) && r(t, s, i);
          else r(t, n[1], n[2]);
        };
      })(),
  ...
  !(function(t, e) {
    ...
    var t = {
      ...
      u = {
        determinate:
          '<div class="deter-bar" role="mpbar1"><div class="peg"></div></div><div class="bar-bg"></div>',
        buffer:
          '<div class="deter-bar" role="mpbar2"><div class="peg"></div></div><div class="buffer-bg" role="bufferBar"></div><div class="mp-ui-dashed" role="dashed"></div>',
        indeterminate:
          '<div class="indeter-bar" role="mpbar3"></div><div class="bar-bg"></div>',
        query:
          '<div class="query-bar" role="mpbar4"><div class="peg"></div></div><div class="bar-bg"></div>'
      },
      l = {},
      f = function(s) {
        var r = e.extend(s, t),
        ...
        return (
          n || ((n = new d(r)), (l[i] = n)),
          'string' == typeof s && 'function' == typeof n[s]
            ? n[s]()
            : r.start && n.start(),
          n
        );
    ...
    return (
      (d.prototype = {
        ...
        start: function() {
          ...
          if (
            (this.status || this._isBufferStyle() || this.set(0),
          ...
          if (this._isIndeterminateStyle())
            return (
              !this._isRendered() &&
                t &&
                (this.set(0), (o = this._getRenderedId()), (n = r)),
        ...
        set: function(t) {
          return (
            (t = e.clamp(t, this.options.minimum, 1)),
            (this.status = 1 === t ? null : t),
            this._setProgress(this._getCurrSelector(), t),
            this
          );
        },
        setBuffer: function(t) {
          return (
            (t = e.clamp(t, this.options.minimum, 1)),
            (this.bufferStatus = 1 === t ? null : t),
            this._setProgress(o, t),
            this
          );
        },
        inc: function(t) {
          var e = this.status,
            s = this.bufferStatus;
          return e
            ? ((e = this._getRandomNum(e, t)),
              this._isBufferStyle() &&
                ((s = this._getRandomNum(s > e ? s : e + 0.1, t)),
                this.setBuffer(s)),
              this.set(e))
            : this.start();
        },
        ...
        _render: function(t) {
          ...
          if (
            ((r.id = this._getRenderedId(!0)),
            (r.className = 'ui-mprogress'),
            (r.innerHTML = i),
            !this._isIndeterminateStyle() && !this._isQueryStyle())
          ) {
            t || (s = !this._isStarted());
          ...
          return (
            n != document.body && e.addClass(n, 'mprogress-custom-parent'),
            n.appendChild(r),
            r
          );
        },
          ...
          return (
            ...
            this._isIndeterminateStyle() || this._isQueryStyle()
              ...
              : void e.queue(function(t) {
                  '' === a.options.positionUsing &&
                    (a.options.positionUsing = a._getPositioningCSS()),
        ...
        _getRandomNum: function(t, s) {
          return (
            'number' != typeof s &&
              (s = (1 - t) * e.clamp(Math.random() * t, 0.1, 0.95)),
            (t = e.clamp(t + s, 0, 0.994))
          );
        },
